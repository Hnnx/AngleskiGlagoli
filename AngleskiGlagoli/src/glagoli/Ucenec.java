...
public class Ucenec extends JFrame {
	...
	// >> Glagoli
	JTextField glagol1, pastS1, pastP1, prevod1, glagol2, pastS2, pastP2, prevod2, glagol3, pastS3, pastP3, prevod3,
			glagol4, pastS4, pastP4, prevod4, glagol5, pastS5, pastP5, prevod5, glagol6, pastS6, pastP6, prevod6,
			glagol7, pastS7, pastP7, prevod7, glagol8, pastS8, pastP8, prevod8, glagol9, pastS9, pastP9, prevod9,
			glagol10, pastS10, pastP10, prevod10, glagol11, pastS11, pastP11, prevod11, glagol12, pastS12, pastP12,
			prevod12, glagol13, pastS13, pastP13, prevod13, glagol14, pastS14, pastP14, prevod14, glagol15, pastS15,
			pastP15, prevod15;
	...
	private JButton check1, check2, check3, check4, check5, check6, check10, check11, check12, check9, check8, check7,
	...
	public Ucenec() {
		...
		glagol1 = makeGlagol("HAVE");
		pastS1 = makeGlagol();
		pastP1 = makeGlagol();
		prevod1 = makeGlagol("IMETI");
		glagoliPanel.add(glagol1);
		glagoliPanel.add(pastS1);
		glagoliPanel.add(pastP1);
		glagoliPanel.add(prevod1);

		glagol2 = makeGlagol("LOSE");
		pastS2 = makeGlagol();
		pastP2 = makeGlagol();
		prevod2 = makeGlagol("IZGUBITI");
		glagoliPanel.add(glagol2);
		glagoliPanel.add(pastS2);
		glagoliPanel.add(pastP2);
		glagoliPanel.add(prevod2);

		glagol3 = makeGlagol("STAND");
		pastS3 = makeGlagol();
		pastP3 = makeGlagol();
		prevod3 = makeGlagol("STATI");
		glagoliPanel.add(glagol3);
		glagoliPanel.add(pastS3);
		glagoliPanel.add(pastP3);
		glagoliPanel.add(prevod3);

		glagol4 = makeGlagol("EAT");
		pastS4 = makeGlagol();
		pastP4 = makeGlagol();
		prevod4 = makeGlagol("JESTI");
		glagoliPanel.add(glagol4);
		glagoliPanel.add(pastS4);
		glagoliPanel.add(pastP4);
		glagoliPanel.add(prevod4);

		glagol5 = makeGlagol("MEET");
		pastS5 = makeGlagol();
		pastP5 = makeGlagol();
		prevod5 = makeGlagol("SRECATI");
		glagoliPanel.add(glagol5);
		glagoliPanel.add(pastS5);
		glagoliPanel.add(pastP5);
		glagoliPanel.add(prevod5);

		glagol6 = makeGlagol("THINK");
		pastS6 = makeGlagol();
		pastP6 = makeGlagol();
		prevod6 = makeGlagol("MISLITI");
		glagoliPanel.add(glagol6);
		glagoliPanel.add(pastS6);
		glagoliPanel.add(pastP6);
		glagoliPanel.add(prevod6);

		glagol7 = makeGlagol("GET");
		pastS7 = makeGlagol();
		pastP7 = makeGlagol();
		prevod7 = makeGlagol("DOBITI");
		glagoliPanel.add(glagol7);
		glagoliPanel.add(pastS7);
		glagoliPanel.add(pastP7);
		glagoliPanel.add(prevod7);

		glagol8 = makeGlagol("DRAW");
		pastS8 = makeGlagol();
		pastP8 = makeGlagol();
		prevod8 = makeGlagol("RISATI");
		glagoliPanel.add(glagol8);
		glagoliPanel.add(pastS8);
		glagoliPanel.add(pastP8);
		glagoliPanel.add(prevod8);

		glagol9 = makeGlagol("KNOW");
		pastS9 = makeGlagol();
		pastP9 = makeGlagol();
		prevod9 = makeGlagol("VEDETI");
		glagoliPanel.add(glagol9);
		glagoliPanel.add(pastS9);
		glagoliPanel.add(pastP9);
		glagoliPanel.add(prevod9);

		glagol10 = makeGlagol("SING");
		pastS10 = makeGlagol();
		pastP10 = makeGlagol();
		prevod10 = makeGlagol("PETI");
		glagoliPanel.add(glagol10);
		glagoliPanel.add(pastS10);
		glagoliPanel.add(pastP10);
		glagoliPanel.add(prevod10);

		glagol11 = makeGlagol("SWIM");
		pastS11 = makeGlagol();
		pastP11 = makeGlagol();
		prevod11 = makeGlagol("PLAVATI");
		glagoliPanel.add(glagol11);
		glagoliPanel.add(pastS11);
		glagoliPanel.add(pastP11);
		glagoliPanel.add(prevod11);

		glagol12 = makeGlagol("TAKE");
		pastS12 = makeGlagol();
		pastP12 = makeGlagol();
		prevod12 = makeGlagol("VZETI");
		glagoliPanel.add(glagol12);
		glagoliPanel.add(pastS12);
		glagoliPanel.add(pastP12);
		glagoliPanel.add(prevod12);

		glagol13 = makeGlagol("FORGET");
		pastS13 = makeGlagol();
		pastP13 = makeGlagol();
		prevod13 = makeGlagol("POZABITI");
		glagoliPanel.add(glagol13);
		glagoliPanel.add(pastS13);
		glagoliPanel.add(pastP13);
		glagoliPanel.add(prevod13);

		glagol14 = makeGlagol("READ");
		pastS14 = makeGlagol();
		pastP14 = makeGlagol();
		prevod14 = makeGlagol("BRATI");
		glagoliPanel.add(glagol14);
		glagoliPanel.add(pastS14);
		glagoliPanel.add(pastP14);
		glagoliPanel.add(prevod14);

		glagol15 = makeGlagol("SEW");
		pastS15 = makeGlagol();
		pastP15 = makeGlagol();
		prevod15 = makeGlagol("SIVATI");
		glagoliPanel.add(glagol15);
		glagoliPanel.add(pastS15);
		glagoliPanel.add(pastP15);
		glagoliPanel.add(prevod15);
		...
		resetButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JTextField[] glagolCol = { glagol1, pastS1, pastP1, prevod1, glagol2, pastS2, pastP2, prevod2, glagol3,
						pastS3, pastP3, prevod3, glagol4, pastS4, pastP4, prevod4, glagol5, pastS5, pastP5, prevod5,
						glagol6, pastS6, pastP6, prevod6, glagol7, pastS7, pastP7, prevod7, glagol8, pastS8, pastP8,
						prevod8, glagol9, pastS9, pastP9, prevod9, glagol10, pastS10, pastP10, prevod10, glagol11,
						pastS11, pastP11, prevod11, glagol12, pastS12, pastP12, prevod12, glagol13, pastS13, pastP13,
						prevod13, glagol14, pastS14, pastP14, prevod14, glagol15, pastS15, pastP15, prevod15,

				};

				JTextField[] pastSimpleCol = { pastS1, pastS2, pastS3, pastS4, pastS5, pastS6, pastS7, pastS8, pastS9,
						pastS10, pastS11, pastS12, pastS13, pastS14, pastS15 };
				JTextField[] pastPrincipleCol = { pastP1, pastP2, pastP3, pastP4, pastP5, pastP6, pastP7, pastP8,
						pastP9, pastP10, pastP11, pastP12, pastP13, pastP14, pastP15 };
		...
		check1 = makeButton("had", pastS1, "had", pastP1);
		checkGridPanel.add(check1);
		check2 = makeButton("lost", pastS2, "lost", pastP2);
		checkGridPanel.add(check2);
		check3 = makeButton("stood", pastS3, "stood", pastP3);
		checkGridPanel.add(check3);
		check4 = makeButton("ate", pastS4, "eaten", pastP4);
		checkGridPanel.add(check4);
		check5 = makeButton("met", pastS5, "met", pastP5);
		checkGridPanel.add(check5);
		check6 = makeButton("thought", pastS6, "thought", pastP6);
		checkGridPanel.add(check6);
		check7 = makeButton("got", pastS7, "got", pastP7);
		checkGridPanel.add(check7);
		check8 = makeButton("drew", pastS8, "drawn", pastP8);
		checkGridPanel.add(check8);
		check9 = makeButton("know", pastS9, "knew", pastP9);
		checkGridPanel.add(check9);
		check10 = makeButton("sang", pastS10, "sung", pastP10);
		checkGridPanel.add(check10);
		check11 = makeButton("swam", pastS11, "swum", pastP11);
		checkGridPanel.add(check11);
		check12 = makeButton("took", pastS12, "taken", pastP12);
		checkGridPanel.add(check12);
		check13 = makeButton("forgot", pastS13, "forgotten", pastP13);
		checkGridPanel.add(check13);
		check14 = makeButton("read", pastS14, "read", pastP14);
		checkGridPanel.add(check14);
		check15 = makeButton("sewed", pastS15, "sewn", pastP15);
		...
		checkAllBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JTextField[] pastSimpleCol = { pastS1, pastS2, pastS3, pastS4, pastS5, pastS6, pastS7, pastS8, pastS9,
						pastS10, pastS11, pastS12, pastS13, pastS14, pastS15 };
				String[] odgovoriSimple = { "had", "lost", "stood", "ate", "met", "thought", "got", "drew", "knew",
						"sang", "swam", "took", "forgot", "read", "sewed" };
				JTextField[] pastPrincipleCol = { pastP1, pastP2, pastP3, pastP4, pastP5, pastP6, pastP7, pastP8,
						pastP9, pastP10, pastP11, pastP12, pastP13, pastP14, pastP15 };
				String[] odgovoriPrinciple = { "had", "lost", "stood", "eaten", "met", "thought", "gotten", "drawn",
						"knew", "sung", "swum", "taken", "forgotten", "read", "sewn" };

				preveriVsaPolja(pastSimpleCol, odgovoriSimple, pastPrincipleCol, odgovoriPrinciple);

			}

			private void preveriVsaPolja(JTextField[] glagolInput, String[] simple, JTextField[] caseCheck,
					String[] principle) {
				tocke = 0;
